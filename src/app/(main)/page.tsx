...
const siteOwner = {
  ...
  image: "/images/ahmadi-pic.jpg", // مسیر عکس پروفایل
  phone: "09020079101",
...
export default async function HomePage(): Promise<JSX.Element> {
  ...
  try {
    posts = await prisma.post.findMany({
      ...
      take: 100, // تعداد کمتر برای نمایش بهتر
      include: {
        author: {
          select: {
            id: true,
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-gray-800 relative inline-block">
              <span className="text-[#FEC360]">آخرین مقالات</span> و تحلیل‌های
              من
              <div className="absolute -bottom-2 left-1/4 w-1/2 h-1 bg-[#FEC360] rounded-full" />
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              تجربیات، تحلیل‌های بازار و راهنمایی‌های تخصصی در حوزه املاک و
              سرمایه‌گذاری
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20">
            ...
            <p className="text-xl text-gray-900 mb-8 max-w-2xl mx-auto leading-8">
              با جستجو در بین {2} ملک فعال، ملک مورد نظرتان را با بهترین قیمت
              پیدا کنید و از مشاوره رایگان ما بهره‌مند شوید
            </p>
