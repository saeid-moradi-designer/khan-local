...
const navLinks: NavLink[] = [
  ...
  { label: "املاک", href: "/properties", icon: Building },
        ...
        <div className="flex items-center gap-2">
          ...
          {userName ? (
            <div className="relative">
              ...
              {/* منوی کاربر */}
              {isUserMenuOpen && (
                <div className="absolute left-0 mt-2 w-64 bg-white/95 rounded-xl shadow-2xl border border-gray-100 py-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-shrink-0">
                        {userImage ? (
                          ...
                          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#FEC360] to-amber-500 flex items-center justify-center text-white font-bold text-lg shadow-sm ring-2 ring-amber-200">
                            {userName.charAt(0)}
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {/* نشان وضعیت آنلاین */}
                          <div className="w-2 h-2 bg-green-500 rounded-full ring-1 ring-white"></div>
                        </div>
